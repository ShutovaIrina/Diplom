...
#Если Сервер Или ТолстыйКлиентОбычноеПриложение Или ВнешнееСоединение Тогда
	...
	Процедура ОбработкаПроведения(Отказ, Режим)
		...
		//Доработка проверка заполнения Шутова И.Н.
	...
	Процедура ВыполнитьАвтозаполнение(ДатаДокумента) Экспорт
		...
		КонецЕсли;
		Услуги.Очистить();
		Сумма = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Договор, "ВКМ_СуммаАбонентскойПлаты");
		...
		Пока Выборка.Следующий() Цикл
			...
			НоваяСтрока.Цена = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Договор, "ВКМ_СтоимостьЧаса");
